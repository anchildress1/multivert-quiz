...
export const descriptions: Readonly<Record<VertType, TypeDescription>> = Object.freeze({
	introvert: {
		...
		deep: {
			...
			youllNeverAdmit:
				"Your favourite version of yourself shows up after the door has closed behind everyone, and you'd like more of her, please."
		}
	},
	...
	otrovert: {
		...
		deep: {
			...
			trueThings: [
				...
				"You've belonged to clubs only as a guest of honour, never as a member.",
